...
class CoFounderAgent(BaseAgent):
    ...
    async def _generate_response(self, state: AgentState, context: Dict[str, Any]) -> AIMessage:
        ...
        # Update next agent based on response content
        ...
        if any(word in content_lower for word in ["legal", "contract", "compliance"]):
        ...
        elif any(word in content_lower for word in ["manufacturing", "production"]):
            ...
            # Default to manager for general business tasks
