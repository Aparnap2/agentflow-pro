...
export const GithubIcon = ({ className = '', size = 16 }: { className?: string; size?: number }) => (
  <svg
    className={className}
    height={size}
    strokeLinejoin="round"
