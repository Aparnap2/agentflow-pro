...
export function IntuitiveChat({ participants, messages, onSendMessage, activeAgent }: IntuitiveChatProps) {
        ...
        <div className="border-t p-4">
          ...
          {activeAgent && (
            <div className="flex items-center gap-2 mt-2 text-xs text-muted-foreground">
              ...
              <span>{activeAgent} is active</span>
            </div>
          )}
        </div>
      </CardContent>
